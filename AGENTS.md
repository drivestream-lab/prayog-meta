...
- Prayog PM bundle @ **v0.5.1**: `/validate-requirements`, `/review-findings`, `/update-documents`, `/prd-impact-map`, `/purge-initiative-artifacts-meta`, `/commit-workspace`, `/open-draft-pr`, `/create-board-tickets`, `/prd`
